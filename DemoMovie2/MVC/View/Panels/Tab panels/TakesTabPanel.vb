Public Class TakesTabPanel

    Protected Friend Overrides Sub OnShowing(e As EventArgs)
        MyBase.OnShowing(e)

        'RefreshTakes()
        TakesList.Takes = GlobalSettings.This.CurrentMovie.GetDummyScene.Takes
    ...
    Private Sub AddNewTake_End(sender As Object, e As EventArgs)
        ...
        If pnl.DialogResult = DialogResult.OK Then
            movie.GetDummyScene.Takes.Add(DirectCast(pnl.DataSource, Take))
            TakesList.Refresh()
        End If
